 ...
 * @LastEditTime: 2023-05-28 12:29:32
 * @FilePath: \study_bug\lib\assembly\MyVideoComment.dart
...
class MyVideoComment extends StatefulWidget {
  String id = '';
  MyVideoComment({super.key, required this.id});

  @override
  // ignore: library_private_types_in_public_api
  _MyVideoCommentState createState() => _MyVideoCommentState();
}

class _MyVideoCommentState extends State<MyVideoComment> {
  List comment_list = [];
        ...
        comment_list_view.add(Padding(
            ...
            child: Row(
              children: [
                TextButton(
                    onPressed: () =>
                        Global.toUserPage(context, tt['userid'] ?? ''),
                    child: MyHeadimage(
                      tt['userheadimg'] ?? '',
                      height: Global.comment_headimage_len,
                      width: Global.comment_headimage_len,

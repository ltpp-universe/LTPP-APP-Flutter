      ...
      return Center(
        ...
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: const InputDecoration(
                labelText: '邮箱', hintText: '邮箱', prefixIcon: Icon(Icons.lock)),
          ),
          Container(
    ...
    return Center(
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: const InputDecoration(
              labelText: '验证码', hintText: '验证码', prefixIcon: Icon(Icons.code)),
        ),
        TextField(
          controller: school_controller,
          decoration: const InputDecoration(
              labelText: '学校', hintText: '学校', prefixIcon: Icon(Icons.house)),
        ),
        TextField(
        ...
        TextField(
          ...
          decoration: const InputDecoration(
              labelText: '专业', hintText: '专业', prefixIcon: Icon(Icons.subject)),
        ),
        TextField(
          controller: class_controller,
          decoration: const InputDecoration(
              labelText: '班级', hintText: '班级', prefixIcon: Icon(Icons.class_)),
        ),
        Container(
            alignment: Alignment.topCenter,
            child: Row(
